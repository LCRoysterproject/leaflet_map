...
**Click on each sensor to view its hourly or discrete water quality data.** 
...
divericon <- makeIcon(
  iconUrl = "C:/Users/melimore86/Desktop/leaflet_map/icon/diver3.png",
  iconWidth = 12, iconHeight = 65)

staricon <- makeIcon(
  iconUrl = "C:/Users/melimore86/Desktop/leaflet_map/icon/star.png",
  iconWidth = 12, iconHeight = 50)

```

```{r r_map, include=FALSE}
intermap<-leaflet() %>%  addProviderTiles("OpenStreetMap.HOT", group = "OpenStreetMap.HOT")%>% 
...
addMarkers(
  ...
  addLayersControl(baseGroups = c("OpenStreetMap.HOT","Esri.NatGeoWorldMap"), 
                   overlayGroups = c("1982 oyster distribution","1995 oyster distribution","2001 oyster distribution","2010 oyster distribution"), 
