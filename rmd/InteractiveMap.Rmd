...
addMarkers(
  ...
  addLayersControl(baseGroups = c("OpenStreetMap.HOT","Esri.NatGeoWorldMap"), overlayGroups = c("1982 oyster distribution","1995 oyster distribution","2001 oyster distribution","2010 oyster distribution"), options = layersControlOptions(collapsed = TRUE)) %>% 
