...
wqplot<-ggplot(data=wq, aes(x=Date))+
  ...
  geom_ribbon(data= dis, aes(y=Values/1000, ymin=0, ymax=Values/1000, fill= "River Discharge"), color= "cornflowerblue", alpha=0.5) +
    geom_point(aes(y= Temperature, fill= "Temperature"),color= "red", size=.65)+
    geom_point(aes(y= Salinity, fill= "Salinity"),color= "black", size=.75)+
...
```{r wqplot, warning= FALSE, fig.width=20,fig.height=12, echo=FALSE}
wqplot
```
