...
The main plot consists of continuous data gathered from a Star-Oddi sensor, which measures salinity, temperature, and conductivity hourly, since August 2017.Missing data are due to lost or stolen sensors.  
...
<<<<<<< HEAD
endDate <- ymd_hms("2019-08-06 23:00:00")
=======
endDate <- ymd_hms("2019-07-03 23:00:00")
>>>>>>> 5b2bf3bc1e3bc17efc53b301d237433a9f1862d0
...
chloro <-
  ...
  ggtitle("CHLOROPHYLL (µg/L)") +
  
  labs(x= "Date", y= "Chlorophyll (µg/L)") +
  
  geom_line(data= dis, aes(y=Discharge/500), color= "cornflowerblue", size=1, alpha=0.6) +
...
color <-
  ...
  geom_line(data= dis, aes(y=Discharge/200), color= "cornflowerblue", size=1, alpha=0.6) +
  
  geom_point(aes(y=Color),color= "black", size=2) +
  
  scale_y_continuous(sec.axis = sec_axis(~.*200,name = "River Discharge (cfs)"),limits=c(0,200)) +
