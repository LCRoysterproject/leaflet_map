...
```{r phos, warning=FALSE, echo=FALSE, message=FALSE,fig.width=8,fig.height=6}
...
<br>
<br>
```{r nitrogen, warning=FALSE, echo=FALSE, message=FALSE,fig.width=8,fig.height=6}
ggplot(data= lab, aes(x= Date)) +
  ggtitle("Nitrogen")+
  ylab ("Nitrogen(µg/L)") +
...
<br>
<br>
```{r chlorophyll, warning=FALSE, echo=FALSE, message=FALSE,fig.width=8,fig.height=6}
ggplot(data= lab, aes(x= Date)) +
  ggtitle("Chlorophyll")+
...
<br>
<br>
```{r color, warning=FALSE, echo=FALSE, message=FALSE,fig.width=8,fig.height=6}
ggplot(data= lab, aes(x= Date)) +
  ggtitle("Color") +
...
<br>
<br>
```{r secchi, warning=FALSE, echo=FALSE, message=FALSE,fig.width=8,fig.height=6}
ggplot(data= lab, aes(x= Date)) +
  ggtitle("Secchi") +
  ylab ("Secchi (ft)") +
...
<br>
<br>
```{r cond, warning=FALSE, echo=FALSE, message=FALSE,fig.width=8,fig.height=6}
ggplot(data= lab, aes(x= Date)) +
